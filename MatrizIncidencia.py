class MatrizIncidencia:
    ...
    def menor_ocorrencia(self, dicionario):
        ...
        for v in vertices:
            fronteiras = self._vizinhanca(v)
            print(f"Vértice {dicionario[v]} tem {menor} arestas: ")
            for chave in fronteiras:
                print("- " + dicionario[chave])
